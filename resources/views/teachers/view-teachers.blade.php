            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('time.table') }}">View-Time-Table</a></li>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="/teacher/images/{{ Auth::user()->image }}" class="rounded-circle" style="width: 10%; height:0%;" alt="profile pic"></td>
                <td>{{ Auth::user()->name }}</td>
                <td>{{ Auth::user()->email }}</td>
                <td>{{ Auth::user()->image }}</td>
                <td>{{ Auth::user()->phonenumber }}</td>
                <td><button class="btn btn-primary"><a href="/teacher/panel/teacher/{{ Auth::user()->name }}/edit/teacher/page/view/edited" class="list-group-item list-group-item-action">Edit</a></button></td>
            </tr>
