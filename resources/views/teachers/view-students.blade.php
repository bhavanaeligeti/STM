            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{ route('time.table') }}">Create-Time-Table</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('notice.teachers') }}">Create-Notice</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('teachers') }}">View-Teachers Profile</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
