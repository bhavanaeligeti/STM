            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{ route('create-users') }}">Create Teachers</a></li>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $data->subject }}</td>
                  <td><button type="button" class="btn btn-success"><a href="/admin/panel/application/status/{{ $data->id }}" class="list-group-item list-group-item-action">View</a></button></td>
                </tr>
                @endforeach
            </tbody>
          </table>
