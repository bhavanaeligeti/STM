            ...
            <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $teacher->image }}</td>
                    <td><button class="btn btn-primary"><a href="{{ route('download.admins.view.download',$teacher->image) }}" class="list-group-item list-group-item-action">Download Now</a></button></td
                  </tr>
                  @endforeach
                </tbody>
              </table>
