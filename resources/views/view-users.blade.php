...
<html lang="en">
  ...
  <body><!-- partial:partials/_navbar.html -->
    ...
    <div class="alert alert-success alert-block d-block"><strong>{{ $message }}</strong></div>
@endif
        <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="/student/images/{{ $users->image }}" class="rounded-circle" style="width: 10%; height:0%;" alt="profile pic"></td>
                <td>{{ $users->name }}</td>
                <td>{{ $users->email }}</td>
                <td>{{ $users->phonenumber }}</td>
                <td><button class="btn btn-primary"><a href="/admin/panel/{{ $users->id }}/edit/student/page/view/edited" class="list-group-item list-group-item-action">Edit</a></button></td>
                <td><button class="btn btn-secondary"><a href="/admin/panel/student-delete/{{ $users->id }}/page/view/del/deleted/student" class="list-group-item list-group-item-action">Delete</a></button></td>
              </tr>
              @endforeach
            </tbody>
          </table>
