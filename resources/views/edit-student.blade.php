  ...
  <body>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="">Users Requests</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="/admin/panel/view-application-students">Request Applications</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
    ...
    @endif
        ...
        <article class="card-body mx-auto" style="max-width: 400px;">
            ...
            <form method="POST" action="/admin/panel/{{$data->id}}/store" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        @enderror
            ...
            <div class="form-group input-group">
                ...
                <input name="email" class="form-control" placeholder="Email address" type="email" value="{{ $data->email }}">
        ...
        @enderror
            <div class="form-group input-group">
                ...
                <input name="phonenumber" value="{{ $data->phonenumber }}" class="form-control" placeholder="Phone number" type="text">
...
@enderror
            ...
            <div class="form-group input-group">
                ...
                <input class="form-control" name="password" value="{{ $data->password }}" placeholder="Create password" type="password">
        ...
        @enderror
            ...
            <input class="form-control" name="image" placeholder="Add Porfile Picture" value="{{ $data->image }}" type="file"><br/>
            @error('image')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
