...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="d-block mx-auto w-100 h-50">
            @foreach ($users as $users)
            <div class="alert alert-success mx-auto" role="alert">
                <h4 class="alert-heading">Importan Note</h4>
                <p>
                    {{ $users->paragraph }}
                    <hr>
                <p class="mb-0">{{ $users->lastnote }}</p><br>
                <td><button class="btn btn-success"><a href="{{ route('delete.notice.admin',$users->id)}}" class="list-group-item list-group-item-action">Delete</a></button></td>
              </div>
            @endforeach
